        ...
        <div class="box big">
                        <div class="content">
                            ...
                            <ul class="nav-left" id="admin-nav" style="overflow-y: scroll;">
                                ...
                                <li style="display: none;">
                                    <a class="nome_evento d_margin_bottom-10" target="_blank"
                                        href="https://doity.com.br/evento-teste-frontend">
                                        Evento Teste Frontend <svg xmlns="http://www.w3.org/2000/svg" width="8"
                                    ...
                                    <a class="" href="https://doity.com.br/admin/eventos/painel/279481">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                            ...
                                            <path
                                                ...
                                                stroke="#5A5A5A" stroke-width="1.5" stroke-linecap="round"
                                                stroke-linejoin="round"></path>
                                            <path d="M9.75 8.75V19" stroke="#5A5A5A" stroke-width="1.5"
                                                stroke-linecap="round" stroke-linejoin="round"></path>
                                            <path d="M5 8.25H19" stroke="#5A5A5A" stroke-width="1.5"
                                                stroke-linecap="round" stroke-linejoin="round"></path>
                                        </svg>
                                        <span>
                                            Painel </span>
                        ...
                        <img src="/img/sidebar_doity/config.png" alt=""/>                        <span>Definições do evento</span>
                                ...
                                <li class="nav-left-li-sub">
                                    <a class="" href="#">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                            ...
                                            <path
                                                ...
                                                stroke="#5A5A5A" stroke-width="1.5" stroke-linecap="round"
                                                stroke-linejoin="round"></path>
                                            <path d="M12 7.75V8.25" stroke="#5A5A5A" stroke-width="1.5"
                                                stroke-linecap="round" stroke-linejoin="round"></path>
                                            <path d="M12 15.75V16.25" stroke="#5A5A5A" stroke-width="1.5"
                                                stroke-linecap="round" stroke-linejoin="round"></path>
                                        </svg>
                                        <span>
                                            Financeiro </span>
                                    ...
                                    <ul class="nav-left-sub">
                                        ...
                                        <li class="">
                                            <a class="green " data-toggle="tooltip" title="Ver detalhes dos pagamentos"
                                        ...
                                        <li class="">
                                            <a class="green" data-toggle="tooltip" title="Gerenciar afiliados do evento"
                                ...
                                <li class="nav-left-li-sub">
                                    ...
                                    <ul class="nav-left-sub">
                                        ...
                                        <li class="">
                                            <a data-toggle="tooltip" title="Adicionar inscrição gratuita/cortesia"
                                                class="green" href="https://doity.com.br/admin/users/add2/279481">
                                                <span>
                                ...
                                <li class="nav-left-li-sub">
                                    <a class="" href="#">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                            ...
                                            <path
                                                ...
                                                stroke="#5A5A5A" stroke-width="1.5" stroke-linecap="round"
                                                stroke-linejoin="round"></path>
                                            <path d="M5 13.25H19" stroke="#5A5A5A" stroke-width="1.5"
                                                stroke-linecap="round" stroke-linejoin="round"></path>
                                            <path d="M8.75 11.75V14.25" stroke="#5A5A5A" stroke-width="1.5"
                                                stroke-linecap="round" stroke-linejoin="round"></path>
                                            <path d="M15.25 11.75V14.25" stroke="#5A5A5A" stroke-width="1.5"
                                                stroke-linecap="round" stroke-linejoin="round"></path>
                                        </svg>
                                        <span>
                                            Secretaria </span>
                                    ...
                                    <ul class="nav-left-sub">
                                        ...
                                        <li class="">
                                            <a class="green" data-toggle="tooltip" title="Baixar lista de frequência"
                                                target="_blank"
                                    ...
                                    <a class="" href="#">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                            ...
                                            <path
                                                ...
                                                stroke="#5A5A5A" stroke-width="1.5" stroke-linecap="round"
                                                stroke-linejoin="round"></path>
                                            <path d="M12 17.5V19.25" stroke="#5A5A5A" stroke-width="1.5"
                                                stroke-linecap="round" stroke-linejoin="round"></path>
                                        </svg>
                                        <span>
                                            Programação </span>
                                ...
                                <li class="nav-left-li-sub">
                                    <a class="" href="https://doity.com.br/admin/certificados/index/279481">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                            viewBox="0 0 24 24" fill="none">
                                            <path d="M14.25 8.75L18.25 4.75H5.75L9.75 8.75" stroke="#5A5A5A"
                                    ...
                                    <a class="" href="#">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                            ...
                                            <path
                                                ...
                                                stroke="#5A5A5A" stroke-width="1.5" stroke-linecap="round"
                                                stroke-linejoin="round"></path>
                                            <path d="M5 12H12H19" stroke="#5A5A5A" stroke-width="1.5"
                                                stroke-linecap="round" stroke-linejoin="round"></path>
                                        </svg>
                                        <span>
                                    ...
                                    <a class="" href="https://doity.com.br/admin/apps/adquirir_app/279481">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                            ...
                                            <path
                                                ...
                                                stroke="#5A5A5A" stroke-width="1.5" stroke-linecap="round"
                                                stroke-linejoin="round"></path>
                                            <path d="M10.25 16.75H9.75" stroke="#5A5A5A" stroke-width="1.5"
                                                stroke-linecap="round" stroke-linejoin="round"></path>
                                            <path
                                    ...
                                    <a class="" href="https://doity.com.br/admin/mailing/index/279481">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                            ...
                                            <path
                                                ...
                                                stroke="#5A5A5A" stroke-width="1.5" stroke-linecap="round"
                                                stroke-linejoin="round"></path>
                                            <path d="M5.5 6.5L12 12.25L18.5 6.5" stroke="#5A5A5A" stroke-width="1.5"
                                                stroke-linecap="round" stroke-linejoin="round"></path>
                                        </svg>
                                        <span style="display: flex; align-items: center; gap: 5px;">
                                    ...
                                    <a class=""
                                        ...
                                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                            ...
                                            <path
                                                ...
                                                stroke="#5A5A5A" stroke-width="1.5" stroke-linecap="round"
                                                stroke-linejoin="round"></path>
                                            <path d="M18 9.25H13.75V5" stroke="#5A5A5A" stroke-width="1.5"
                                                stroke-linecap="round" stroke-linejoin="round"></path>
                                            <path d="M9.75 15.25H14.25" stroke="#5A5A5A" stroke-width="1.5"
                                                stroke-linecap="round" stroke-linejoin="round"></path>
                                            <path d="M9.75 12.25H14.25" stroke="#5A5A5A" stroke-width="1.5"
                                                stroke-linecap="round" stroke-linejoin="round"></path>
                                        </svg>
                                        <span style="display: flex; align-items: center; gap: 5px;">
                                    ...
                                    <a href="https://doity.com.br/admin/eventos/add">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                            ...
                                            <path
                                                ...
                                                stroke="#5A5A5A" stroke-width="1.5" stroke-linecap="round"
                                                stroke-linejoin="round"></path>
                                            <path d="M12 8.75V15.25" stroke="#5A5A5A" stroke-width="1.5"
                                                stroke-linecap="round" stroke-linejoin="round"></path>
                                            <path d="M15.25 12H8.75" stroke="#5A5A5A" stroke-width="1.5"
                                                stroke-linecap="round" stroke-linejoin="round"></path>
                                        </svg>
                                        <span>
                                            Novo evento </span>
                    ...
                    <div id="modalCredenciamentoMenu" style="display:none; ">
                        ...
                        <div class="modal modal-custom fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"
                            aria-hidden="true"
                            style="width: 100%; max-width: 714px; box-shadow: unset; border: none; transform: unset; margin: -250px 0 0 -357px;">
                            <div id="modal_premium_content" class="modal_mobile d_display-flex d_gap-10 d_padding-20">
                                ...
                                <div id="modal_premium_text"
                                    ...
                                    <p class="d_text-dark d_font_size-20 d_font_weight-700 d_margin_bottom-05">Este é um
                                        recurso premium</p>
                                    <br>
                                    <p class="d_text-dark d_font_size-12 d_font_weight-400">Faça o upgrade para o
                                        <b>Credenciamento profissional</b> e adquira facilidades na hora de credenciar
                                        os participantes. </p>
                                    ...
                                    <a class="btn_solicitar_orcamento d_button" style="width: 100% !important;"
...
<div class="__centered">
    <a class="nome_evento" href="https://doity.com.br/evento-teste-frontend" target="_blank">Evento Teste Frontend<svg
            style="margin-left: 3px; width: 10px; height: 10px;" xmlns="http://www.w3.org/2000/svg" width="8" height="8"
    ...
    <div class="__left __top_menu-mobile">
        ...
        <a class="__mobile-criar_novo"
            ...
            <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 18 18" fill="none">
                <path d="M9 4.3125V13.6875" stroke="white" stroke-width="1.5" stroke-linecap="round"
                    stroke-linejoin="round"></path>
                <path d="M13.6875 9H4.3125" stroke="white" stroke-width="1.5" stroke-linecap="round"
                    stroke-linejoin="round"></path>
            </svg>
        </a>
    </div>
        ...
        <div class="__notificacoes">
            <a href="#" id="top-menu-help" class="open-help-admin">
                ...
                <i class="fa fa-question-circle-o"
                    style="font-size: 18px; vertical-align: middle;margin-right: 5px;"></i>
            </a>
        </div>
        ...
        <div class="__perfil __showAndHide" data-toggle="nav.__menu" id="perfil">
            ...
            <nav class="__menu" id="menu">
                <ul class="__menu-root">
                    ...
                    <li>
                        <a href="https://doity.com.br/area-do-participante/painel">Área do
                            Participante</a>
                    </li>
                    <li>
